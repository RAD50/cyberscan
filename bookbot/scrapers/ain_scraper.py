"""
Scraper for Ain Bookstore (https://ainbookstore.com/).
Ain Bookstore is a WooCommerce-based store; search URL pattern: /?s=QUERY&post_type=product
"""
...
class AinScraper(BaseScraper):
    """Scraper for Ain Bookstore."""

    def __init__(self):
        super().__init__(store_name="Ain Bookstore", base_url="https://ainbookstore.com")

    async def search(self, query: str) -> list[dict]:
        """Search Ain Bookstore for books matching the query."""
