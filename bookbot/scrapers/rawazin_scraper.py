"""
Scraper for Rawazin bookstore (https://rawazin.om/).
Rawazin is a WooCommerce-based store; search URL pattern: /?s=QUERY&post_type=product
"""
...
class RawazinScraper(BaseScraper):
    """Scraper for Rawazin bookstore."""

    def __init__(self):
        super().__init__(store_name="Rawazin", base_url="https://rawazin.om")

    async def search(self, query: str) -> list[dict]:
        """Search Rawazin for books matching the query."""
