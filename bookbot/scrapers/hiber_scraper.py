"""
Scraper for Hiber bookstore (https://hiber.om/).
Hiber is a WooCommerce-based store; search URL pattern: /?s=QUERY&post_type=product
"""
...
class HiberScraper(BaseScraper):
    """Scraper for Hiber bookstore."""

    def __init__(self):
        super().__init__(store_name="Hiber", base_url="https://hiber.om")

    async def search(self, query: str) -> list[dict]:
        """Search Hiber for books matching the query."""
        ...
        results = []
        # WooCommerce product listing: look for product items
